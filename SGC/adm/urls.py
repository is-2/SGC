...
urlpatterns = patterns('',
    ...
    url(r'^adm/list_projects/project_report/(?P<id_project>\d+)/$', views.project_report, name='project_report'),
    url(r'^adm/list_projects/changes_report/(?P<id_project>\d+)/$', views.changes_report, name='changes_report'),    
    ...
    url(r'^adm/list_projects/manage_project_phases/(?P<id_project>\d+)/modify_phase_state/(?P<id_phase>\d+)/$', views.modify_phase_state, name='modify_phase_state'),
