...
urlpatterns = patterns('',
    ...
    url(r'gdc/set_pending_predecessor/(?P<id_item>\d+)/(?P<id_pred>\d+)/$', views.set_pending_predecessor, name='set_pending_predecessor'),
    url(r'gdc/unset_pending_predecessor/(?P<id_item>\d+)/$', views.unset_pending_predecessor, name='unset_pending_predecessor'),
    url(r'gdc/list_pending_fathers/(?P<id_item>\d+)/$', views.list_pending_fathers, name='list_pending_fathers'),
    url(r'gdc/set_pending_father/(?P<id_item>\d+)/(?P<id_father>\d+)/$', views.set_pending_father, name='set_pending_father'),
    url(r'gdc/unset_pending_father/(?P<id_item>\d+)/$', views.unset_pending_father, name='unset_pending_father'),
    url(r'gdc/finish_pending_item/(?P<id_item>\d+)/$', views.finish_pending_item, name='finish_pending_item'),
)