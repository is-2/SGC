...
urlpatterns = patterns('',
    ...
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/$', views.list_items, name='list_items'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/create_item/$', views.create_item, name='create_item'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/modify_item/(?P<id_item>\d+)/$', views.modify_item, name='modify_item'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/delete_item/(?P<id_item>\d+)/$', views.delete_item, name='delete_item'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/assign_item_type/(?P<id_item>\d+)/$', views.assign_item_type, name='assign_item_type'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/assign_item_type/(?P<id_item>\d+)/add_item_type/(?P<id_item_type>\d+)/$', views.add_item_type, name='add_item_type'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/item_history/(?P<id_item>\d+)/$', views.item_history, name='item_history'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/item_history/(?P<id_item>\d+)/revert_item/(?P<id_version>\d+)/$', views.revert_item, name='revert_item'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_attributes/(?P<id_item>\d+)/$', views.list_attributes, name='list_attributes'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_attributes/(?P<id_item>\d+)/set_attribute_value/(?P<id_attr>\d+)/$', views.set_attribute_value, name='set_attribute_value'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_deleted_items/$', views.list_deleted_items, name='list_deleted_items'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_deleted_items/(?P<id_item>\d+)/revive_item/$', views.revive_item, name='revive_item'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_predecessors/(?P<id_item>\d+)/$', views.list_predecessors, name='list_predecessors'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_predecessors/(?P<id_item>\d+)/set_predecessor/(?P<id_pred>\d+)/$', views.set_predecessor, name='set_predecessor'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_fathers/(?P<id_item>\d+)/$', views.list_fathers, name='list_fathers'),
    url(r'des/des/list_user_projects/(?P<id_user>\d+)/list_project_phases/(?P<id_project>\d+)/list_items/(?P<id_phase>\d+)/list_fathers/(?P<id_item>\d+)/set_father/(?P<id_father>\d+)/$', views.set_father, name='set_father'),
